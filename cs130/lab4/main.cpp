...
Vector3 SUN(0.0, 0.0, 0.0);
Vector3 EARTH(60.0, 20.0, -20.0);
Vector3 ASTRO(100.0, 20.0, 100.0);
...
void GLrender()
{
	...
	glPushMatrix();	// push astronaught
	glTranslatef(ASTRO.x, 0, ASTRO.z);
	glutSolidSphere(1, 100, 100);
	glPopMatrix();	// pop astronaught
...
void GLupdate()
{
	...
	EARTH.x = sin(elapsed/10)*90;
	EARTH.z = cos(elapsed/10)*90;

	ASTRO.x = sin(elapsed*5/10)*15;
	ASTRO.z = cos(elapsed*5/10)*15;
